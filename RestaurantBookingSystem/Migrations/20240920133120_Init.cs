    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "pelle@larsson.com", "Pelle Larsson", "pelle@larsson.com", null },
                    { 2, "veragd@gmail.com", "Vera Gunnarsdottir", "veragd@gmail.com", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Spaghetti with pancetta, egg, Parmesan, Pecorino, and black pepper.", 2, true, true, "Pasta Carbonara", 195 },
                    { 2, "Tomato sauce, fresh mozzarella, basil, and extra virgin olive oil.", 1, true, true, "Margherita", 175 },
                    { 3, "Fresh tomatoes, mozzarella, basil, and extra virgin olive oil.", 3, true, false, "Caprese Salad", 145 },
                    { 4, "Creamy Arborio rice cooked with saffron, Parmesan, and butter.", 4, true, false, "Risotto alla Milanese", 215 },
                    { 5, "Toasted bread topped with fresh tomatoes, garlic, basil, and olive oil.", 5, true, false, "Bruschetta al Pomodoro", 115 },
                    { 6, "Tomato sauce, mozzarella, ham and pineapple.", 1, true, true, "Hawaii", 190 }
                });
